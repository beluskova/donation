$(document).ready(function() {
	 ...
	 * @param str str is list of strings : username, latitude, longitude    
	 * str[0] is user's (donor's) firstName                
	 * str[1] is user's latitude                              
	 * str[2] is user's longitude                             
	 * 
	...
	function fitBounds(latlngStr) {
		...
		for (i = 0; i < latlngStr.length; i++) {
			...
			//respond to click on marker by displaying user's (donor's) name 
